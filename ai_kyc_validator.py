    ...
    try:
        ...
        if file_path.lower().endswith(('.jpg', '.jpeg', '.png', '.bmp', '.tiff')):
            try:
                ...
                if total_pixels < 30000:  # Very low resolution
                    critical_issues.append('Image resolution too low (below 30K pixels)')
                    score -= 40
                elif total_pixels < 30000:  # Low resolution
                    issues.append('Image resolution below recommended (below 30K pixels)')
                    score -= 20
